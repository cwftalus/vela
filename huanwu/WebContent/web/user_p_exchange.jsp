...
<title>会员中心[我参与的交换] - 换物网用户后台</title>
<link rel="stylesheet" type="text/css" href="../css/user_globals.css" />
<link rel="stylesheet" type="text/css" href="../css/user_p_exchnage.css" />
...
<div class="content">
  ...
  <div class="con_l_menu">
    <ul>
      <li><a href="/user.html"   >我的名片</a></li>
	  <li><a href="/user_reg_up.html"   >注册信息修改</a></li>
    </ul>
  </div>
  ...
  <div class="con_l_menu">
    <ul>
      ...
      <li><a href="/user_p_exchange.html" class="con_l_menu_over" >我参与的交换</a></li>
    </ul>
  </div>
  <div class="con_l_title">
    <div class="con_l_title_ba">
    ...
    <div class="con_r">
      ...
      <div class="my_g" >
        ...
        <div class="my_g_list">
          <div class="list">
            <ul class="list_t">
              <li class="l_t_1">换品</li>
              <li class="l_t_2">上传时间</li>
              <li class="l_t_3">意向交换</li>
              <li class="l_t_4">交换状态</li>
              <li class="l_t_5">操作</li>
            </ul>
